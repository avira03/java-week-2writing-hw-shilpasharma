...
public class Programme_4 {
    ...
    //4.5 declare the main methood
    //4.6 call all four instance and static variables into both instance and static methods into the main method and run the programme.
